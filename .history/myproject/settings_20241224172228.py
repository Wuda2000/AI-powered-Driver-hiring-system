...
# Specify directories to find static files
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # This points to the 'static' folder in your project root
]
...
# For development, static files should be automatically served
if DEBUG:
    # This makes sure static files are served automatically by Django during development
