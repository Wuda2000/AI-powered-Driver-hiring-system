    ...
    if request.method == "POST":
        ...
        if user is not None:
            ...
            if hasattr(user, 'driverprofile'):
                return redirect('driver_profile')  # Redirect to driver profile
            elif hasattr(user, 'carownerprofile'):
                return redirect('car_owner_profile')  # Redirect to car owner profile
        else:
...
def driver_profile_view(request):
    ...
    return render(request, "driver_profile.html", {"profile": driver_profile})

@login_required
def car_owner_profile_view(request):
    car_owner_profile = request.user.carownerprofile
    return render(request, "car_owner_profile.html", {"profile": car_owner_profile})



def car_owner_profile(request):
    return render(request, 'website/car_owner_profile.html')

def driver_profile(request):
    return render(request, 'website/driver_profile.html')