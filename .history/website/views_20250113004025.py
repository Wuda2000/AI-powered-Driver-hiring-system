    ...
    if request.method == "POST":
        ...
        if user is not None:
            ...
            if hasattr(user, 'driver_profile'):
                return redirect('driver_profile')  # Replace with your driver's profile URL name
            elif hasattr(user, 'car_owner_profile'):
                return redirect('car_owner_profile')  # Replace with your car owner's profile URL name
        else:
...
def car_owner_profile_view(request):
    car_owner_profile = request.user.car_owner_profile
